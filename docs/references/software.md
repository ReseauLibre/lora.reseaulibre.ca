...
- [jeremiah-k/meshtastic-matrix-relay](https://github.com/jeremiah-k/meshtastic-matrix-relay): [Matrix](https://matrix.org) bridge, see the
  [Using the Matrix bridge](#using-the-matrix-bridge) for more usage tips
...
second, better positioned, relay to transmit its traffic.[^1]

[^1]: This is not ideal: ideally, we'd connect directly to the better
